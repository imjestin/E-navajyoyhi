...
from . import (hod_views, roster_views, setup_views, staff_views,
               student_views, views)
...
urlpatterns = [
    ...
    path("settings/", hod_views.site_settings_view, name='site_settings'),
    ...
    path('student-list/<str:course_ids>/', hod_views.course_student_list, name='course_student_list'),
    path("attendance/view/", hod_views.admin_view_attendance,
         name="admin_view_attendance",),
    path("attendance/fetch/", hod_views.get_admin_attendance,
         name='get_admin_attendance'),
    path("attendance/export/", hod_views.export_attendance, name='export_attendance'),
    path("student/add/", hod_views.add_student, name='add_student'),
    path("subject/add/", hod_views.add_subject, name='add_subject'),
    # Rosters: searchable, filterable, paginated, importable/exportable.
    path("staff/manage/", roster_views.manage_staff, name='manage_staff'),
    path("student/manage/", roster_views.manage_student, name='manage_student'),
    path("student/import/", roster_views.import_students, name='import_students'),
    path("staff/import/", roster_views.import_staff, name='import_staff'),
    path("student/export/", roster_views.export_students, name='export_students'),
    path("staff/export/", roster_views.export_staff, name='export_staff'),
    path("student/import/template/", roster_views.sample_student_csv, name='sample_student_csv'),
    path("staff/import/template/", roster_views.sample_staff_csv, name='sample_staff_csv'),
    ...
    path('staff/attendance-report/',staff_views.attendance_report, name='attendance_report'),
    ...
    path("student/view/<int:student_id>",
         hod_views.view_profile, name='view_profile'),
    path("staff/view/<int:staff_id>",
         hod_views.view_staff_profile, name='view_staff_profile'),
