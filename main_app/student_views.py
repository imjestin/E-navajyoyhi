...
def student_home(request):
    ...
    total_subject = Subject.objects.filter(course=student.course,session=student.session).count()
...
def student_view_attendance(request):
    ...
    if request.method != 'POST':
        ...
        context = {
            'subjects': Subject.objects.filter(course=course,session=student.session),
